namespace Winfocus.LMS.Application.DTOs.QuestionConfig
{
    ...
    /// <summary>
    /// Filter request for Question Configuration list endpoint.
    /// Extends <see cref="PagedRequest"/> with master-specific filters.
    /// </summary>
    public class QuestionConfigurationFilterRequest : PagedRequest
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the optional academic year filter.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the optional question type filter.
        /// </summary>
