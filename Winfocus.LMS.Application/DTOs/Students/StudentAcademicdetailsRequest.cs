...
[Required] List<Guid> batchTimingstaurdayIds, [Required] List<Guid> batchTimingSundayIds, Guid batchId, Guid preferredbatchtimeId, string pastyearperformance, string pastschoolname, string pastschoollocation, string emirates, Guid userid, string registraionNumber);
}
