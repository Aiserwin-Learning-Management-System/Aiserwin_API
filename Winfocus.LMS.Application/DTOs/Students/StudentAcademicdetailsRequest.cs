...
[Required] List<Guid> batchTimingstaurdayIds, [Required] List<Guid> batchTimingSundayIds, Guid batchId, string preferredtime, string pastyearperformance, string pastschoolname, string pastschoollocation, string emirates, Guid userid, string registraionNumber);
}
