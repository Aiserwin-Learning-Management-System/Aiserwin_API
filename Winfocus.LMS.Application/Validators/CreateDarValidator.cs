...
{
    /// <summary>
    /// Validator for DarRequestDto when creating a Daily Activity Report.
    /// </summary>
    public class CreateDarValidator : AbstractValidator<DarRequestDto>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDarValidator"/> class.
        /// </summary>
        public CreateDarValidator()
        {
