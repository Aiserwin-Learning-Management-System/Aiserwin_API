...
namespace Winfocus.LMS.Infrastructure.Migrations
{
    ...
    [Migration("20260331075103_teachettable_modified")]
    partial class teachettable_modified
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Winfocus.LMS.Domain.Entities.TeacherPreferredGrade", b =>
                {
                    ...
                    b.HasIndex("TeacherRegistrationId", "ExamGradeId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Winfocus.LMS.Domain.Entities.TeacherPreferredSubject", b =>
                {
                    ...
                    b.HasIndex("TeacherRegistrationId", "ExamSubjectId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Winfocus.LMS.Domain.Entities.TeacherProfessionalDetail", b =>
                {
                    ...
                    b.Property<string>("AdditionalCourses")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("HasTeachingCertification")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Winfocus.LMS.Domain.Entities.TeacherSyllabus", b =>
                {
                    ...
                    b.Property<Guid>("ExamSyllabusId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ExamSyllabusId");

                    b.HasIndex("TeacherRegistrationId", "ExamSyllabusId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Winfocus.LMS.Domain.Entities.TeacherPreferredGrade", b =>
                {
                    b.HasOne("Winfocus.LMS.Domain.Entities.ExamGrade", "ExamGrade")
                        .WithMany()
                        .HasForeignKey("ExamGradeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Winfocus.LMS.Domain.Entities.TeacherPreferredSubject", b =>
                {
                    b.HasOne("Winfocus.LMS.Domain.Entities.ExamSubject", "ExamSubject")
                        .WithMany()
            ...
            modelBuilder.Entity("Winfocus.LMS.Domain.Entities.TeacherSyllabus", b =>
                {
                    b.HasOne("Winfocus.LMS.Domain.Entities.ExamSyllabus", "ExamSyllabus")
                        .WithMany()
                        .HasForeignKey("ExamSyllabusId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
