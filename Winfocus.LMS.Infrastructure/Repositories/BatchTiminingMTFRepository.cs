...
namespace Winfocus.LMS.Infrastructure.Repositories
{
    ...
    public class BatchTiminingMTFRepository : IBatchTimingMTFRepository
    {
        ...
        {
            var res = _dbContext.BatchTimingMTFs.Where(x => !x.IsDeleted)
               .Include(x => x.Subject)
        ...
        public async Task<bool> DeleteAsync(Guid id, Guid centerId)
        {
            ...
            if (centerId != Guid.Empty && centerId != Guid.Empty && entity.Subject.Course.Stream.Grade.Syllabus.CenterId != centerId)
            {
                return false;
            }
